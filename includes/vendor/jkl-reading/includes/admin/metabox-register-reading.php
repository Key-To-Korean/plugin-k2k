...
add_action( 'cmb2_admin_init', 'k2k_register_metabox_reading' );
/**
 * Register a custom metabox for the 'k2k-reading' Post Type.
 *
 * @link https://github.com/CMB2/CMB2/wiki
 */
function k2k_register_metabox_reading() {

	$prefix = 'k2k_reading_meta_';

	$k2k_metabox = new_cmb2_box(
		array(
			'id'           => $prefix . 'metabox',
			'title'        => esc_html__( 'Reading Meta', 'k2k' ),
			'object_types' => array( 'k2k-reading' ),
			'closed'       => false,
			'tabs'         => array(
				array(
					'id'     => 'tab-info',
	...
	$k2k_metabox->add_field(
		array(
			...
			'taxonomy' => 'k2k-reading-author', // Taxonomy Slug.
	...
	$k2k_metabox->add_field(
		array(
			...
			'taxonomy' => 'k2k-reading-level', // Taxonomy Slug.
			// 'inline'   => true, // Toggles display to inline.
		)
	);
	...
	$k2k_metabox->add_field(
		array(
			...
			'id'       => $prefix . 'length',
			'type'     => 'taxonomy_radio_inline',
			'taxonomy' => 'k2k-reading-length', // Taxonomy Slug.
			// 'inline'   => true, // Toggles display to inline.
		)
	);
	...
	$k2k_metabox->add_field(
		array(
			...
			'taxonomy' => 'k2k-reading-genre', // Taxonomy Slug.
		)
	);
	...
	$k2k_metabox->add_field(
		array(
			...
			'id'       => $prefix . 'topic',
			'type'     => 'taxonomy_select', // Or `taxonomy_multicheck_inline`/`taxonomy_multicheck_hierarchical`.
			'taxonomy' => 'k2k-reading-topic', // Taxonomy Slug.
		)
	);
	...
	$k2k_metabox->add_field(
		array(
			...
			'id'       => $prefix . 'source',
			'type'     => 'taxonomy_select', // Or `taxonomy_multicheck_inline`/`taxonomy_multicheck_hierarchical`.
			'taxonomy' => 'k2k-reading-source', // Taxonomy Slug.
		)
	);
