...
if ( ! class_exists( 'CMB2_Switch_Button' ) ) {
	...
	class CMB2_Switch_Button {
		...
		/**
		 * Create the CMB2 Switch Button class.
		 */
		 ...
		 * @param string $escaped_value The value to be escaped.
		 * @param string $object_id The object ID.
		 * @param string $object_type The object type.
		 * @param mixed  $field_type_object The type of field object.
		 */
